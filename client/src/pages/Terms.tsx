      ...
      <div className="container mx-auto px-3 sm:px-4 py-4 sm:py-8 max-w-3xl">
        ...
        <Card className="shadow-sm">
          <CardHeader className="px-4 sm:px-6 pt-4 sm:pt-6 pb-2 sm:pb-4">
            <CardTitle className="text-xl sm:text-2xl">이용약관</CardTitle>
          ...
          <CardContent className="px-4 sm:px-6 pb-6 text-sm sm:text-base leading-relaxed">
            <section className="mb-6">
              <h2 className="text-base sm:text-lg font-semibold mb-2 text-gray-900 dark:text-white">제1조 (목적)</h2>
            ...
            <section className="mb-6">
              <h2 className="text-base sm:text-lg font-semibold mb-2 text-gray-900 dark:text-white">제2조 (용어의 정의)</h2>
            ...
            <section className="mb-6">
              <h2 className="text-base sm:text-lg font-semibold mb-2 text-gray-900 dark:text-white">제3조 (약관의 효력 및 변경)</h2>
              <ol className="list-decimal pl-5 space-y-1.5 text-gray-700 dark:text-gray-300">
            ...
            <section className="mb-6">
              <h2 className="text-base sm:text-lg font-semibold mb-2 text-gray-900 dark:text-white">제4조 (서비스의 내용)</h2>
              <p className="mb-2 text-gray-700 dark:text-gray-300">회사는 다음과 같은 서비스를 제공합니다:</p>
            ...
            <section className="mb-6">
              <h2 className="text-base sm:text-lg font-semibold mb-2 text-gray-900 dark:text-white">제5조 (회원가입)</h2>
              <ol className="list-decimal pl-5 space-y-1.5 text-gray-700 dark:text-gray-300">
            ...
            <section className="mb-6">
              <h2 className="text-base sm:text-lg font-semibold mb-2 text-gray-900 dark:text-white">제6조 (유료서비스)</h2>
              <ol className="list-decimal pl-5 space-y-1.5 text-gray-700 dark:text-gray-300">
            ...
            <section className="mb-6">
              <h2 className="text-base sm:text-lg font-semibold mb-2 text-gray-900 dark:text-white">제7조 (서비스 이용 제한)</h2>
              <p className="mb-2 text-gray-700 dark:text-gray-300">회사는 회원이 다음 각 호에 해당하는 경우 서비스 이용을 제한할 수 있습니다:</p>
              <ul className="list-disc pl-5 space-y-1.5 text-gray-700 dark:text-gray-300">
                <li>본 약관을 위반한 경우</li>
            ...
            <section className="mb-6">
              <h2 className="text-base sm:text-lg font-semibold mb-2 text-gray-900 dark:text-white">제8조 (면책조항)</h2>
              <ol className="list-decimal pl-5 space-y-1.5 text-gray-700 dark:text-gray-300">
            ...
            <section>
              ...
              <p className="text-gray-700 dark:text-gray-300">본 약관은 2025년 1월 25일부터 시행됩니다.</p>
            </section>
          </CardContent>
        </Card>
      </div>
