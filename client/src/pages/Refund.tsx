      ...
      <div className="container mx-auto px-3 sm:px-4 py-4 sm:py-8 max-w-3xl">
        ...
        <Card className="shadow-sm">
          <CardHeader className="px-4 sm:px-6 pt-4 sm:pt-6 pb-2 sm:pb-4">
            <CardTitle className="text-xl sm:text-2xl">환불 정책</CardTitle>
          ...
          <CardContent className="px-4 sm:px-6 pb-6 text-sm sm:text-base leading-relaxed">
            <section className="mb-6">
              <h2 className="text-base sm:text-lg font-semibold mb-2 text-gray-900 dark:text-white">제1조 (청약철회)</h2>
            ...
            <section className="mb-6">
              <h2 className="text-base sm:text-lg font-semibold mb-2 text-gray-900 dark:text-white">제2조 (환불 절차)</h2>
              <ol className="list-decimal pl-5 space-y-1.5 text-gray-700 dark:text-gray-300">
            ...
            <section className="mb-6">
              <h2 className="text-base sm:text-lg font-semibold mb-2 text-gray-900 dark:text-white">제3조 (환불 제한)</h2>
              <p className="mb-2 text-gray-700 dark:text-gray-300">다음의 경우 환불이 제한될 수 있습니다:</p>
            ...
            <section className="mb-6">
              <h2 className="text-base sm:text-lg font-semibold mb-2 text-gray-900 dark:text-white">제4조 (부분 환불)</h2>
              <ol className="list-decimal pl-5 space-y-1.5 text-gray-700 dark:text-gray-300">
            ...
            <section className="mb-6">
              <h2 className="text-base sm:text-lg font-semibold mb-2 text-gray-900 dark:text-white">제5조 (플랜 변경)</h2>
              <ol className="list-decimal pl-5 space-y-1.5 text-gray-700 dark:text-gray-300">
            ...
            <section className="mb-6">
              <h2 className="text-base sm:text-lg font-semibold mb-2 text-gray-900 dark:text-white">제6조 (구독 해지)</h2>
              <ol className="list-decimal pl-5 space-y-1.5 text-gray-700 dark:text-gray-300">
            ...
            <section>
              <h2 className="text-base sm:text-lg font-semibold mb-2 text-gray-900 dark:text-white">제7조 (문의)</h2>
