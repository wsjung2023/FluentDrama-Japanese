      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <Card>
          ...
          <CardContent className="prose dark:prose-invert max-w-none">
            <h2 className="text-xl font-semibold mt-6">제1조 (개인정보의 수집 항목 및 방법)</h2>
            <p>회사는 다음과 같은 개인정보를 수집합니다:</p>
            <ul className="list-disc pl-6 space-y-2">
              <li>필수항목: 이메일 주소, 비밀번호(암호화 저장)</li>
              <li>선택항목: 이름, 프로필 이미지</li>
              <li>소셜 로그인 시: 소셜 계정 고유 ID, 이메일, 프로필 정보</li>
              <li>서비스 이용 시 자동 수집: 서비스 이용 기록, 접속 로그, IP 주소</li>
            </ul>

            <h2 className="text-xl font-semibold mt-6">제2조 (개인정보의 수집 및 이용 목적)</h2>
            ...
            <h2 className="text-xl font-semibold mt-6">제3조 (개인정보의 보유 및 이용 기간)</h2>
            ...
            <h2 className="text-xl font-semibold mt-6">제4조 (개인정보의 제3자 제공)</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold mt-6">제5조 (개인정보 처리 위탁)</h2>
            ...
            <table className="min-w-full border-collapse border border-gray-300 mt-4">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="border border-gray-300 px-4 py-2">AI 대화 생성</td>
                </tr>
                <tr>
                  <td className="border border-gray-300 px-4 py-2">Neon</td>
                  <td className="border border-gray-300 px-4 py-2">데이터베이스 호스팅</td>
                </tr>
              </tbody>
            </table>

            <h2 className="text-xl font-semibold mt-6">제6조 (이용자의 권리)</h2>
            ...
            <h2 className="text-xl font-semibold mt-6">제7조 (개인정보의 안전성 확보 조치)</h2>
            ...
            <h2 className="text-xl font-semibold mt-6">제8조 (개인정보 보호책임자)</h2>
            <ul className="list-none pl-6 space-y-1">
              <li>담당자: 개인정보보호팀</li>
              <li>이메일: privacy@fluentdrama.com</li>
            </ul>

            <h2 className="text-xl font-semibold mt-6">제9조 (권익침해 구제방법)</h2>
            <p>개인정보 침해에 대한 상담이 필요한 경우 다음 기관에 문의할 수 있습니다:</p>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <p>본 개인정보처리방침은 2025년 1월 25일부터 시행됩니다.</p>
          </CardContent>
        </Card>
      </div>
    </div>
